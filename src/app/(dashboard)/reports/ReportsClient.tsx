...
export default function ReportsClient({ settings }: Props) {
  const cards = [
    ...
    { href: '/reports/department-breakdown', icon: Package, title: 'Department Breakdown', desc: `Every ${settings.gatewayLabel.toLowerCase()} under each ${settings.productLabel.toLowerCase()}, filterable and printable.` },
