...
import { LayoutDashboard, TrendingUp, FilePlus, Upload, FileText, Settings, ChevronRight, BarChart2, Sparkles, Target } from 'lucide-react'
...
interface Props { settings: OrgSettings; onNavigate?: () => void }
      ...
      <div className="flex-shrink-0">
        <div className="px-4 pb-1">
          <a href="/manual" target="_blank" rel="noopener noreferrer"
            ...
            style={{ color: 'rgba(147,197,253,0.6)' }}>📖 User Manual</a>
        </div>
        {session?.user && (
        ...
        <Link href="/about" onClick={onNavigate}
          ...
          <span className="text-[10px]" style={{ color: 'rgba(147,197,253,0.5)' }}>Powered by Tihems</span>
        </Link>
      </div>
    </aside>
  )
